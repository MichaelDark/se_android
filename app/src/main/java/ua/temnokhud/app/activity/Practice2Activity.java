...
public class Practice2Activity extends BaseActivity implements CalculatorListener {
    ...
    int getContentViewLayoutRes() {
        return R.layout.activity_practice_2;
    }
    ...
    void onCreateViews(Bundle savedInstanceState) {
        ...
        btnCalculate = findViewById(R.id.activity_practice_2_txv_calculate);

        btnSum = findViewById(R.id.activity_practice_2_txv_sum);
        btnSubtract = findViewById(R.id.activity_practice_2_txv_subtract);
        btnMultiply = findViewById(R.id.activity_practice_2_txv_multiply);
        btnDivide = findViewById(R.id.activity_practice_2_txv_divide);

        btnNumber0 = findViewById(R.id.activity_practice_2_txv_number_0);
        btnNumber1 = findViewById(R.id.activity_practice_2_txv_number_1);
        btnNumber2 = findViewById(R.id.activity_practice_2_txv_number_2);
        btnNumber3 = findViewById(R.id.activity_practice_2_txv_number_3);
        btnNumber4 = findViewById(R.id.activity_practice_2_txv_number_4);
        btnNumber5 = findViewById(R.id.activity_practice_2_txv_number_5);
        btnNumber6 = findViewById(R.id.activity_practice_2_txv_number_6);
        btnNumber7 = findViewById(R.id.activity_practice_2_txv_number_7);
        btnNumber8 = findViewById(R.id.activity_practice_2_txv_number_8);
        btnNumber9 = findViewById(R.id.activity_practice_2_txv_number_9);
